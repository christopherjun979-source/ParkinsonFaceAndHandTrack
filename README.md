...
* **Color-coded:** Separates the wrist base, pinky, thumb, index, middle, ring fingers, individually whilst visually using distinct colors to match the data display with the camera mesh.
